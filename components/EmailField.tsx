...
export const EmailField: React.FC<EmailFieldProps> = ({ value, onChange }) => {
    return (
        <label className="flex flex-col w-full">
            ...
            <input
                className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-lg text-white focus:outline-0 focus:ring-2 border h-14 p-3.75 text-base font-normal leading-normal"
