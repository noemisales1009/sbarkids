...
const SbarHeader: React.FC<SbarHeaderProps> = ({ onBack }) => {
    return (
        <header className="fixed top-0 left-0 right-0 z-10 flex items-center bg-background-light dark:bg-background-dark p-4 pb-2 justify-between border-b border-gray-200 dark:border-gray-800">
            <button 
