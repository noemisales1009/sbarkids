...
const SbarStatusSection: React.FC<SbarStatusSectionProps> = ({ currentStatus, onStatusChange }) => {
    ...
    return (
        <div className="flex flex-col rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900/50">
            <p className="p-4 text-gray-900 dark:text-white text-base font-medium leading-normal border-b border-gray-200 dark:border-gray-800">Status do Paciente</p>
            <div className="p-4 space-y-4">
                <div className="w-full">
                     <select
                        value={currentStatus || ''}
                        onChange={(e) => onStatusChange(e.target.value as PatientStatus)}
                        className="form-select w-full h-11 rounded-lg border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary"
                    >
                 ...
                 {config && currentStatus && (
                     <div className="flex items-center gap-3 rounded-lg bg-gray-100 dark:bg-gray-800 p-3 mt-2">
