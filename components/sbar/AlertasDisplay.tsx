  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className="bg-gradient-to-r from-red-600 to-red-700 dark:from-red-900 dark:to-red-800 rounded-lg p-4 text-white border border-red-300 dark:border-red-700 cursor-pointer hover:shadow-lg transition-shadow"
      >
